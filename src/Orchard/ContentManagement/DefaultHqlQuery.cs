...
namespace Orchard.ContentManagement
{
    ...
    public class DefaultHqlQuery : IHqlQuery
    {
        ...
        public string ToSql(bool count)
        {
            ...
            var hql = ToHql(count);
            var queryExpression = new StringQueryExpression(hql);
            var translators = TranslatorFactory.CreateQueryTranslators(queryExpression, null, false, sessionImp.EnabledFilters, sessionImp.Factory);
